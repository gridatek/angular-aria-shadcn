...
@Component({
  ...
  template: `
    <div #container [class]="containerClass()" [class.fullscreen]="isFullscreen()">
      <!-- Toolbar -->
      @if (showToolbar()) {
        ...
        @if (error()) {
          <div class="absolute inset-0 flex items-center justify-center bg-background z-10">
            <div class="flex flex-col items-center gap-3 text-center px-4">
              ...
              <p class="text-sm font-medium text-foreground">Failed to load PDF</p>
...
export class ScPdfViewer {
  ...
  protected readonly containerClass = computed(() =>
    cn('flex flex-col bg-background border rounded-lg overflow-hidden', this.class()),
  );

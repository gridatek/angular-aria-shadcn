...
export class ScSignaturePad {
  ...
  protected readonly containerClass = computed(() => cn('relative inline-block', this.class()));
  ...
  protected readonly controlsClass = computed(() => cn('absolute top-2 right-2 flex gap-1'));

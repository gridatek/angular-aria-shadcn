...
@Component({
  ...
  template: `
    <div #viewport class="h-full w-full overflow-scroll scrollbar-none" [class]="viewportClass()">
...
export class ScScrollArea {
  ...
  protected readonly hostClass = computed(() => cn('relative overflow-hidden', this.classInput()));

  protected readonly viewportClass = computed(() => cn('', this.viewportClassInput()));

...
export const SC_NUMBER_INPUT = new InjectionToken<ScNumberInput>('SC_NUMBER_INPUT');
...
export class ScNumberInputStepper {
  ...
  protected readonly class = computed(() =>
    cn('flex flex-col border-l border-input w-6 rounded-r-md overflow-hidden', this.classInput()),
  );
}

...
const positionMap: Record<PopoverSide, Record<PopoverAlign, ConnectedPosition>> = {
  top: {
    start: { originX: 'start', originY: 'top', overlayX: 'start', overlayY: 'bottom', offsetY: -4 },
    center: {
      originX: 'center',
      originY: 'top',
      overlayX: 'center',
    ...
    end: { originX: 'end', originY: 'top', overlayX: 'end', overlayY: 'bottom', offsetY: -4 },
  },
  bottom: {
  ...
  left: {
    start: { originX: 'start', originY: 'top', overlayX: 'end', overlayY: 'top', offsetX: -4 },
    center: {
      originX: 'start',
      originY: 'center',
      overlayX: 'end',
    ...
    end: { originX: 'start', originY: 'bottom', overlayX: 'end', overlayY: 'bottom', offsetX: -4 },
  },
  right: {
    start: { originX: 'end', originY: 'top', overlayX: 'start', overlayY: 'top', offsetX: 4 },
    center: {
      originX: 'end',
      originY: 'center',
      overlayX: 'start',
    ...
    end: { originX: 'end', originY: 'bottom', overlayX: 'start', overlayY: 'bottom', offsetX: 4 },
  },
};

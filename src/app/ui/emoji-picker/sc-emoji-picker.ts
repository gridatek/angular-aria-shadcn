...
const DEFAULT_CATEGORIES: EmojiCategory[] = [
  {
    ...
    emojis: [
      ...
      { emoji: '😅', name: 'grinning face with sweat', keywords: ['hot', 'nervous'] },
      { emoji: '🤣', name: 'rolling on the floor laughing', keywords: ['lol', 'laugh'] },
      { emoji: '😂', name: 'face with tears of joy', keywords: ['laugh', 'cry'] },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🖐️', name: 'hand with fingers splayed', keywords: ['high five'] },
      ...
      { emoji: '🙌', name: 'raising hands', keywords: ['celebration', 'hooray'] },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🍜', name: 'steaming bowl', keywords: ['food', 'noodles', 'ramen'] },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🥋', name: 'martial arts uniform', keywords: ['sport', 'karate'] },
      { emoji: '🎯', name: 'direct hit', keywords: ['game', 'target', 'bullseye'] },
      ...
      { emoji: '🎤', name: 'microphone', keywords: ['music', 'sing', 'karaoke'] },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🔌', name: 'electric plug', keywords: ['power', 'electricity'] },
      ...
      <div [class]="gridContainerClass()">
        @if (searchQuery()) {
          ...
          @if (filteredEmojis().length > 0) {
            ...
            <div class="p-4 text-center text-sm text-muted-foreground">No emoji found</div>
          }
        } @else {
          <!-- Category emojis -->
          @for (category of categories(); track category.id) {
...
export class ScEmojiPicker {
  ...
  protected readonly containerClass = computed(() =>
    cn('w-72 rounded-lg border bg-popover text-popover-foreground shadow-md', this.classInput()),
  );
  ...
  protected readonly gridContainerClass = computed(() => cn('h-64 overflow-y-auto'));

  protected readonly gridClass = computed(() => cn('grid gap-1', `grid-cols-${this.columns()}`));

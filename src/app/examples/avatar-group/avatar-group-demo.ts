...
import { ScAvatarGroup, type AvatarGroupItem } from '../../ui/avatar-group';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Stacked avatars with overflow indicator.</p>
        <sc-avatar-group
          [avatars]="users()"
          [max]="4"
        ...
        />
        @if (clickedUser()) {
          <p class="mt-2 text-sm text-muted-foreground">Clicked: {{ clickedUser() }}</p>
        }
      </section>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Different sizes for various contexts.</p>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Avatars without images show initials.</p>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Common use case for showing team members.</p>

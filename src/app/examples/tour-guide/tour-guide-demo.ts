...
import { ScTourGuide, TourService, TourOptions } from '../../ui/tour-guide';
    ...
    <div class="space-y-8">
      ...
      <div class="grid gap-6 md:grid-cols-3">
        ...
        <div id="tour-card-3" class="p-6 border rounded-lg bg-card">
          ...
          <p class="text-sm text-muted-foreground">Generate and export detailed reports.</p>
        </div>
      </div>
    ...
    const options: TourOptions = {
      steps: [
        ...
        },
        {
          ...
          content: 'Configure your account settings, preferences, and notification options here.',
          placement: 'bottom',
        },
        {
          target: '#tour-card-3',
          title: 'Reports Section',
          content: 'Generate detailed reports and export them in various formats for analysis.',
          placement: 'bottom',
        },
        {
          target: '#tour-form',
        ...
        },
        {
          ...
          title: 'Start Again',
          content: 'Click this button anytime to restart the tour and learn about new features.',
          placement: 'bottom',
        },
      ],
      showProgress: true,

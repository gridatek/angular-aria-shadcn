  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Quick selection presets for common date ranges.</p>
        <div>
          <sc-date-range-picker
            [(value)]="presetRange"
            [presets]="presets"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Hide the clear button from the trigger.</p>
        <div>
...
export class ScDateRangePickerDemo {
  ...
  readonly analyticsRange = signal<DateRange>({ from: undefined, to: undefined });

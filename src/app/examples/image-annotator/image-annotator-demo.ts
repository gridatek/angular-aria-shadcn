...
import { ScImageAnnotator, type Annotation } from '../../ui/image-annotator';
    ...
    <div class="space-y-8">
      ...
      <section>
        ...
        <sc-image-annotator
          ...
          (save)="onSave($event)"
        />
        <p class="mt-2 text-sm text-muted-foreground">Annotations: {{ annotationCount() }}</p>
      </section>
      ...
      <section>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
          <div class="p-4 border rounded-lg">
            ...
            <p class="text-sm text-muted-foreground">Freehand drawing. Click and drag to draw.</p>
          </div>
          <div class="p-4 border rounded-lg">
            <h4 class="font-medium mb-2">Line Tool</h4>
            <p class="text-sm text-muted-foreground">Draw straight lines between two points.</p>
          </div>
          <div class="p-4 border rounded-lg">
            <h4 class="font-medium mb-2">Rectangle Tool</h4>
            <p class="text-sm text-muted-foreground">Draw rectangles by clicking and dragging.</p>
          </div>
          <div class="p-4 border rounded-lg">
            <h4 class="font-medium mb-2">Circle Tool</h4>
            <p class="text-sm text-muted-foreground">Draw circles from center outward.</p>
          </div>
          <div class="p-4 border rounded-lg">
            <h4 class="font-medium mb-2">Arrow Tool</h4>
            <p class="text-sm text-muted-foreground">Draw arrows to point at things.</p>
          </div>
          <div class="p-4 border rounded-lg">
            <h4 class="font-medium mb-2">Eraser Tool</h4>
            <p class="text-sm text-muted-foreground">Remove annotations by clicking on them.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Annotator with custom dimensions.</p>

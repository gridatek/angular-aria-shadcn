    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex flex-col items-center gap-2">
            <button sc-language-toggle variant="outline" size="icon" [iconOnly]="true"></button>
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Dropdown showing all available languages</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Shows labels in English instead of native names</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="text-sm text-muted-foreground"
            >Shows current language with dropdown icon</span
          >
        </div>
      </div>

...
import { ScToggle } from '../../ui/toggle';
  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <button sc-toggle variant="outline" [(pressed)]="italic" aria-label="Toggle italic">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <button sc-toggle [pressed]="true" [disabled]="true" aria-label="Toggle disabled pressed">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-1 rounded-md border p-1">
          ...
          <button sc-toggle [(pressed)]="toolbarItalic" aria-label="Toggle italic">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <button sc-toggle [(pressed)]="toolbarUnderline" aria-label="Toggle underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <button sc-toggle [(pressed)]="toolbarStrike" aria-label="Toggle strikethrough">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"

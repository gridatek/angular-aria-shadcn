...
@Component({
  ...
  imports: [ScTimezoneDisplay, ScTimezoneSelect, ScTimezoneButton, ScTimezoneBadge],
  template: `
    <div class="space-y-8">
      <!-- Basic Select -->
      <div class="space-y-4">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="text-sm text-muted-foreground">Shows current timezone abbreviation</span>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="text-sm text-muted-foreground">Shows abbreviation and UTC offset</span>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex flex-col items-center gap-2">
            <button sc-timezone-display variant="outline" size="icon" [iconOnly]="true"></button>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="text-sm text-muted-foreground"
            >Shows current timezone with dropdown icon</span
          >
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Compact badge for headers and status bars</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center justify-between rounded-lg border p-4">
          <div class="space-y-0.5">
            ...
            <p class="text-sm text-muted-foreground">Your current timezone setting</p>
          </div>
          <button sc-timezone-display variant="outline"></button>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4 rounded-lg border p-4">
          <span sc-timezone-badge></span>
          <span class="text-lg font-mono">{{ timezoneService.currentTimeFormatted() }}</span>
        </div>
        <p class="text-sm text-muted-foreground">Shows the current time in the selected timezone</p>
      </div>
    </div>
  `,

    ...
    <div class="flex flex-col gap-8">
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center gap-4">
          <sc-animated-counter [value]="basicValue()" class="text-4xl font-bold" />
          <button
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center gap-4">
          <sc-animated-counter [value]="largeValue()" separator="," class="text-3xl font-bold" />
          <button
            class="rounded-md bg-primary px-3 py-1.5 text-sm text-primary-foreground hover:bg-primary/90"
            (click)="addLarge()"
          >
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-3 gap-4">
          <div class="rounded-lg border bg-card p-4 text-center">
            ...
            <sc-animated-counter [value]="statsUsers()" class="text-2xl font-bold" />
          </div>
          <div class="rounded-lg border bg-card p-4 text-center">

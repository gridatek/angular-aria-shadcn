...
import { ScCountdown, ScCountdownSimple, CountdownTime } from '../../ui/countdown';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Smaller, more compact display.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Each unit displayed in a card.</p>
        <div class="p-6 rounded-lg border inline-block">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Hide the separator between units.</p>
        <div class="p-6 rounded-lg border inline-block">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Show only hours, minutes, and seconds.</p>
        <div class="p-4 rounded-lg border inline-block">
          <sc-countdown [targetDate]="shortFuture" [showDays]="false" variant="compact" />
        </div>
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Inline countdown display for simple use cases.</p>
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2">
            ...
            <sc-countdown-simple [targetDate]="shortFuture" format="hh:mm:ss" class="text-lg" />
          </div>
          <div class="flex items-center gap-2">
            <span class="text-muted-foreground">MM:SS:</span>
            <sc-countdown-simple [targetDate]="veryShortFuture" format="mm:ss" class="text-lg" />
          </div>
        </div>
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Countdown styled for a product launch or event.</p>
        <div
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Countdown for a limited time offer.</p>
        <div
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">When the countdown reaches zero.</p>
        <div class="p-6 rounded-lg border inline-block">
          <sc-countdown [targetDate]="pastDate" variant="cards" />
        </div>
        <p class="text-sm text-muted-foreground">The countdown shows all zeros when complete.</p>
      </section>
    </div>
  `,

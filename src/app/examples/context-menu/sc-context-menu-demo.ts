      ...
      <sc-context-menu-content>
        ...
        <div sc-context-menu-sub>
          ...
          <div sc-context-menu-sub-content>
            ...
            <div sc-context-menu-item (select)="onSelect('Name Window')">Name Window...</div>
            <div sc-context-menu-separator></div>
            <div sc-context-menu-item (select)="onSelect('Developer Tools')">Developer Tools</div>
          </div>
        </div>
        ...
        <div sc-context-menu-item (select)="onSelect('Show Full URLs')">Show Full URLs</div>
      </sc-context-menu-content>
    </div>
  `,

...
import { ScMentionInput, MentionUser } from '../../ui/mention-input';
    ...
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Type &#64; to trigger the mention dropdown. Select a user to insert a mention.
        </p>
        <div class="max-w-lg">
          <sc-mention-input
            [(value)]="basicValue"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Mention users that have avatar images.</p>
        <div class="max-w-lg">
          <sc-mention-input
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Use # instead of &#64; to trigger mentions (e.g., for hashtags or channels).
        </p>
        <div class="max-w-lg">
          <sc-mention-input
            [users]="channelList"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Disabled mention input state.</p>
        <div class="max-w-lg">
...
export class ScMentionInputDemo {
  ...
  readonly usersWithAvatars: MentionUser[] = [
    ...
    { id: '3', name: 'Emily Chen', username: 'echen', avatar: 'https://i.pravatar.cc/150?u=emily' },
    {
      id: '4',
      name: 'Michael Park',
      username: 'mpark',

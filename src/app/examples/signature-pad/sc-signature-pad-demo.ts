...
import { ScSignaturePad } from '../../ui/signature-pad';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Draw your signature using mouse or touch.</p>
        <sc-signature-pad
          #pad1
          [width]="400"
          [height]="200"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Blue pen on light gray background.</p>
        <sc-signature-pad
          [width]="400"
          [height]="200"
          [penColor]="'#1d4ed8'"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Thicker pen stroke for bold signatures.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Hide the built-in undo/clear buttons.</p>
        <sc-signature-pad #pad2 [width]="400" [height]="150" [showControls]="false" />
        <div class="flex gap-2">
          <button
            (click)="pad2.undo()"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Signature pad in disabled state.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Compact signature pad for limited space.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Track signature state for form validation.</p>
        <div class="space-y-4">
          <div>
          ...
          <div>
            ...
            <sc-signature-pad [width]="400" [height]="150" [(isEmpty)]="signatureIsEmpty" />
            @if (signatureIsEmpty()) {

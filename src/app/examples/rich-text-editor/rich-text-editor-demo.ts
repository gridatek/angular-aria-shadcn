...
import { ScRichTextEditor, ToolbarConfig } from '../../ui/rich-text-editor';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        <sc-rich-text-editor [(value)]="noCountContent" [showCount]="false" [minHeight]="'100px'" />
      </section>

      <!-- Readonly Mode -->
      <section>
        <h3 class="text-lg font-semibold mb-4">Readonly Mode</h3>
        <sc-rich-text-editor [value]="readonlyContent" [readonly]="true" [showToolbar]="false" />
      </section>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">
          Try all the formatting options: bold, italic, headings, lists, links, blockquotes, and
          more.
        </p>
        <sc-rich-text-editor
          [(value)]="fullContent"

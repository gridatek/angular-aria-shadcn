        ...
        <div class="rounded-lg border p-4">
          ...
          <div sc-timeline class="ml-2">
            ...
            <div sc-timeline-item class="pb-4">
              ...
              <div sc-timeline-content class="space-y-0">
                <p class="text-sm">
                  <span class="font-medium">Jane Smith</span> completed the review
                </p>
            ...
            <div sc-timeline-item class="pb-4">
              ...
              <div sc-timeline-content class="space-y-0">
                <p class="text-sm"><span class="font-medium">Bob Wilson</span> added a comment</p>
            ...
            <div sc-timeline-item class="pb-0">
              <div sc-timeline-dot size="sm" variant="outline"></div>
              <div sc-timeline-content class="space-y-0">
                <p class="text-sm"><span class="font-medium">Alice Brown</span> joined the team</p>

  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color1" class="space-y-4 rounded-lg border p-4">
          ...
          <p class="mt-2 text-sm text-muted-foreground">Selected: {{ color1() }}</p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color2" class="space-y-4 rounded-lg border p-4">
            <div sc-color-picker-area></div>
            <div sc-color-picker-hue></div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color3" class="space-y-4 rounded-lg border p-4">
            <div sc-color-picker-area></div>
            <div sc-color-picker-hue></div>
            <div class="flex items-center gap-3">
              <div sc-color-picker-preview></div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color4" class="space-y-4 rounded-lg border p-4">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-[200px]">
          <div sc-color-picker [(value)]="color5" class="space-y-3 rounded-lg border p-3">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color6" class="space-y-4 rounded-lg border p-4">
            <div sc-color-picker-area></div>
            <div sc-color-picker-hue></div>
            <div class="flex items-center gap-3">
              <div sc-color-picker-preview></div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-xs">
          <div sc-color-picker [(value)]="color7" class="space-y-4 rounded-lg border p-4">
            <div sc-color-picker-area></div>
            <div sc-color-picker-hue></div>
            <div class="flex items-center gap-3">
              <div sc-color-picker-preview></div>
        ...
        <div class="flex gap-4">
          ...
          <div class="space-y-2">
            <div class="flex items-center gap-2">
              <div class="size-4 rounded" [style.background-color]="color1()"></div>
              <span class="font-mono text-sm">{{ color1() }}</span>
            </div>
            <p class="text-sm text-muted-foreground">Use the picker above to change this color</p>
          </div>
        </div>
      </div>
    </div>

...
import { ScQrCode, ScQrCodeDownload } from '../../ui/qr-code';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Generate a QR code from any text or URL.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Type text to generate a QR code in real-time.</p>
        <input
          type="text"
          [(ngModel)]="inputValue"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          QR code with a centered logo overlay. Use higher error correction for best results.
        </p>
        <div class="flex gap-4 flex-wrap">
          <sc-qr-code
      ...
      <section class="space-y-3">
        ...
        <div class="flex gap-4 flex-wrap items-end">
          <div class="text-center">
            <sc-qr-code [value]="'No border'" [size]="150" [quietZone]="0" class="border" />
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">QR code with built-in download functionality.</p>
        <sc-qr-code-download
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">QR codes for various types of content.</p>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div class="text-center">
            <sc-qr-code [value]="'WIFI:T:WPA;S:MyNetwork;P:password123;;'" [size]="120" />

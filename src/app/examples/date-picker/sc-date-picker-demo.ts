...
import { ScDatePicker } from '../../ui/date-picker';
  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <sc-date-picker [(selected)]="selectedDate2" placeholder="Select your birthday" />
      </div>
      ...
      <div class="space-y-4">
        ...
        @if (selectedDates().length > 0) {
          <p class="text-sm text-muted-foreground">{{ selectedDates().length }} date(s) selected</p>
        }
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-xs text-muted-foreground">Only dates within the next 30 days</p>
        <sc-date-picker

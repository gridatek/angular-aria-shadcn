    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">
          Press <kbd sc-kbd size="sm">⌘</kbd> <kbd sc-kbd size="sm">K</kbd> to open the command
          palette, or <kbd sc-kbd size="sm">Esc</kbd> to close it.
        </p>
        <p class="text-sm text-muted-foreground">
          Use <kbd sc-kbd size="sm">Tab</kbd> to navigate between fields and
          <kbd sc-kbd size="sm">Enter</kbd> to submit.
        </p>
      </div>

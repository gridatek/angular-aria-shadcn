        ...
        <div class="space-y-4">
          ...
          @if (croppedImage()) {
            <div class="space-y-2">
              ...
              <img [src]="croppedImage()" class="max-w-xs rounded-md border" alt="Cropped result" />
            </div>
          }
        </div>
      </div>
        ...
        <div class="rounded-md border p-4 bg-muted/50">
          <div class="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span class="ml-2 font-mono">{{ cropArea().width.toFixed(0) }}px</span>
            </div>
            <div>
              <span class="text-muted-foreground">Height:</span>
              <span class="ml-2 font-mono">{{ cropArea().height.toFixed(0) }}px</span>
            </div>
          </div>
        </div>
      </div>

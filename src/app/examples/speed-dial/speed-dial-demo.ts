  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        <div class="relative h-64 border rounded-lg bg-muted/20">
          <div class="absolute bottom-4 right-4">
            <sc-speed-dial [actions]="basicActions()" (actionClick)="onActionClick($event)" />
          </div>
        </div>
        @if (lastAction()) {
          <p class="mt-2 text-sm text-muted-foreground">Last action: {{ lastAction() }}</p>
        }
      </section>
      ...
      <section>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="relative h-48 border rounded-lg bg-muted/20">
            ...
            <span class="absolute top-2 left-2 text-xs text-muted-foreground">Up (default)</span>
          </div>
          ...
          <div class="relative h-48 border rounded-lg bg-muted/20">
            ...
            <span class="absolute top-2 left-2 text-xs text-muted-foreground">Down</span>
          </div>
          ...
          <div class="relative h-48 border rounded-lg bg-muted/20">
            ...
            <span class="absolute top-2 left-2 text-xs text-muted-foreground">Left</span>
          </div>
          ...
          <div class="relative h-48 border rounded-lg bg-muted/20">
            ...
            <span class="absolute top-2 left-2 text-xs text-muted-foreground">Right</span>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Customize the main FAB and close icons.</p>
        <div class="relative h-64 border rounded-lg bg-muted/20">
          <div class="absolute bottom-4 right-4">
            <sc-speed-dial
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Speed dial comes in different sizes.</p>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Some actions can be disabled.</p>
        <div class="relative h-64 border rounded-lg bg-muted/20">
          <div class="absolute bottom-4 right-4">
            <sc-speed-dial

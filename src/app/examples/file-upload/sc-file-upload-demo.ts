  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-lg">
          <div sc-file-upload [multiple]="true" [(files)]="dropzoneFiles" (error)="onError($event)">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-lg">
          <div sc-file-upload [multiple]="true" [(files)]="buttonFiles" (error)="onError($event)">
            ...
            <div sc-file-upload-dropzone class="p-6">
              <div class="flex flex-col items-center gap-2 text-center">
                ...
                <p class="text-sm text-muted-foreground">
                  {{
                    singleFile().length > 0 ? singleFile()[0].file.name : 'Click or drag to upload'
                  }}
                </p>
              </div>
            </div>

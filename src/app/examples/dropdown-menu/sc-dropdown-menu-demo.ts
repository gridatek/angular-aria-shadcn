    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div sc-dropdown-menu>
          <button sc-button variant="outline" sc-dropdown-menu-trigger [cdkMenuTriggerFor]="menu1">
            Open Menu
          </button>
          <ng-template #menu1>
      ...
      <div class="space-y-4">
        ...
        <div sc-dropdown-menu>
          <button sc-button variant="outline" sc-dropdown-menu-trigger [cdkMenuTriggerFor]="menu2">
            Open
          </button>
          <ng-template #menu2>
      ...
      <div class="space-y-4">
        ...
        <div sc-dropdown-menu>
          <button sc-button variant="outline" sc-dropdown-menu-trigger [cdkMenuTriggerFor]="menu3">
            View Options
          </button>
          <ng-template #menu3>
            <div sc-dropdown-menu-content class="w-56">
              ...
              <div sc-dropdown-menu-separator></div>
              <div sc-dropdown-menu-checkbox-item [(checked)]="showStatusBar">Status Bar</div>
              <div sc-dropdown-menu-checkbox-item [(checked)]="showActivityBar">Activity Bar</div>
              <div sc-dropdown-menu-checkbox-item [(checked)]="showPanel">Panel</div>
            </div>
          </ng-template>
        </div>
        <p class="text-xs text-muted-foreground">
          Status: {{ showStatusBar() }}, Activity: {{ showActivityBar() }}, Panel: {{ showPanel() }}
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div sc-dropdown-menu>
          <button sc-button variant="outline" sc-dropdown-menu-trigger [cdkMenuTriggerFor]="menu4">
            Select Position
          </button>
          <ng-template #menu4>
            <div sc-dropdown-menu-content class="w-56">
      ...
      <div class="space-y-4">
        ...
        <div sc-dropdown-menu>
          <button sc-button variant="outline" sc-dropdown-menu-trigger [cdkMenuTriggerFor]="menu5">
            Options
          </button>
          <ng-template #menu5>
            <div sc-dropdown-menu-content class="w-56">
              ...
              <div sc-dropdown-menu-sub>
                <div sc-dropdown-menu-sub-trigger [cdkMenuTriggerFor]="submenu">More Tools</div>
                <ng-template #submenu>

  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        <div class="h-[400px]">
          <sc-pdf-viewer [src]="currentPdf()" [showToolbar]="false" class="h-full" />
        </div>
      </section>

      <!-- Custom Toolbar Config -->
      <section>
        <h3 class="text-lg font-medium mb-4">Custom Toolbar (Navigation Only)</h3>
        <div class="h-[400px]">
          <sc-pdf-viewer
            [src]="currentPdf()"
            [toolbarConfig]="{
...
export class PdfViewerDemoComponent {
  ...
  readonly currentPdf = signal('https://www.w3.org/WAI/WCAG21/Techniques/pdf/img/table-word.pdf');

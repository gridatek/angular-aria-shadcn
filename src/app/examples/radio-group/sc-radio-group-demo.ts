      ...
      <div class="space-y-4">
        ...
        <div sc-radio-group [(value)]="defaultValue">
          <div class="flex items-center space-x-2">
            ...
            <label for="r1" class="text-sm font-medium leading-none">Default</label>
          </div>
          <div class="flex items-center space-x-2">
            <sc-radio-group-item value="comfortable" id="r2" />
            <label for="r2" class="text-sm font-medium leading-none">Comfortable</label>
          </div>
          <div class="flex items-center space-x-2">
            <sc-radio-group-item value="compact" id="r3" />
            <label for="r3" class="text-sm font-medium leading-none">Compact</label>
          </div>
        </div>
        <p class="text-sm text-muted-foreground">Selected: {{ defaultValue() || 'none' }}</p>
      </div>

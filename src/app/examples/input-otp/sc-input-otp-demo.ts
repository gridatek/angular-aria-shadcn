  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Value: {{ separatorOtp() || 'empty' }}</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Value: {{ pinOtp() || 'empty' }}</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Value: {{ dotOtp() || 'empty' }}</p>
      </div>
        ...
        <div class="rounded-lg border p-6 max-w-sm">
          <div class="space-y-4">
            <div class="space-y-2 text-center">
              ...
              <p class="text-sm text-muted-foreground">We sent a code to your email address</p>
            </div>

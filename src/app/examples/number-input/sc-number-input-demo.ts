    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <p class="text-sm text-muted-foreground">Value: {{ basicValue() ?? 'null' }}</p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
          <div sc-number-input [(value)]="minMaxValue" [min]="0" [max]="100" class="w-32">
            <button sc-number-input-decrement></button>
            <input sc-number-input-field />
            <button sc-number-input-increment></button>
          </div>
          <p class="text-sm text-muted-foreground">Value: {{ minMaxValue() }}</p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
          <div sc-number-input [(value)]="stepValue" [step]="0.5" [min]="0" [max]="10" class="w-32">
            <button sc-number-input-decrement></button>
            <input sc-number-input-field />
            <button sc-number-input-increment></button>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
          <div sc-number-input [(value)]="decimalValue" [step]="0.01" class="w-36">
            <button sc-number-input-decrement></button>
            <input sc-number-input-field />
            <button sc-number-input-increment></button>
          </div>
          <p class="text-sm text-muted-foreground">Value: {{ decimalValue() }}</p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-2">
          <div sc-number-input [(value)]="stepperValue" [min]="0" [max]="99" class="w-24">
            <input sc-number-input-field class="text-right pr-1" />
            <div sc-number-input-stepper></div>
          </div>
          <p class="text-sm text-muted-foreground">Value: {{ stepperValue() }}</p>
        </div>
      </div>

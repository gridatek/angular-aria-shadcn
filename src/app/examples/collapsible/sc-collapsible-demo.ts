...
import { ScCollapsible, ScCollapsibleContent, ScCollapsibleTrigger } from '../../ui/collapsible';
  ...
  template: `
    <div class="flex flex-col gap-8">
      ...
      <div sc-collapsible [open]="true" class="w-[350px] space-y-2">
        ...
        <div sc-collapsible-content>
          <div class="rounded-md border px-4 py-3 text-sm">
            This collapsible is open by default. You can toggle it closed by clicking the button.
          </div>
        </div>
      </div>
      ...
      <div sc-collapsible [disabled]="true" class="w-[350px] space-y-2">
        <div class="flex items-center justify-between space-x-4 px-4">
          <h4 class="text-sm font-semibold text-muted-foreground">Disabled Collapsible</h4>
          <button
            sc-collapsible-trigger
        ...
        <div sc-collapsible-content>
          <div class="rounded-md border px-4 py-3 text-sm">This content is hidden.</div>
        </div>
      </div>
    </div>
  `,

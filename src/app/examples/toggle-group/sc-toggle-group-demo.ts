...
import { ScToggleGroup, ScToggleGroupItem } from '../../ui/toggle-group';
  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-muted-foreground">Selected: {{ alignment() || 'none' }}</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div sc-toggle-group type="multiple" [(value)]="formatting" aria-label="Text formatting">
          ...
          <button sc-toggle-group-item value="underline" aria-label="Toggle underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <p class="text-sm text-muted-foreground">Selected: {{ formattingDisplay() }}</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-4">
          <div sc-toggle-group type="single" size="sm" aria-label="Small toggle group">
          ...
          <div sc-toggle-group type="single" size="default" aria-label="Default toggle group">
            <button sc-toggle-group-item value="a" aria-label="Option A">A</button>
            <button sc-toggle-group-item value="b" aria-label="Option B">B</button>
            <button sc-toggle-group-item value="c" aria-label="Option C">C</button>
          </div>
          <div sc-toggle-group type="single" size="lg" aria-label="Large toggle group">
            <button sc-toggle-group-item value="a" aria-label="Option A">A</button>
            <button sc-toggle-group-item value="b" aria-label="Option B">B</button>
            <button sc-toggle-group-item value="c" aria-label="Option C">C</button>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-4">
          <div sc-toggle-group type="single" [disabled]="true" aria-label="Disabled toggle group">
            <button sc-toggle-group-item value="a" aria-label="Option A">A</button>
            <button sc-toggle-group-item value="b" aria-label="Option B">B</button>
            <button sc-toggle-group-item value="c" aria-label="Option C">C</button>
          </div>
          <div sc-toggle-group type="single" aria-label="Toggle group with disabled item">
            <button sc-toggle-group-item value="a" aria-label="Option A">A</button>
            <button

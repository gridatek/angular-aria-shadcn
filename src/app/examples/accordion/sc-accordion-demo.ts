  ...
  template: `
    <div class="flex flex-col gap-8">
      ...
      <div class="w-full max-w-md">
        <h3 class="mb-4 text-sm font-medium text-muted-foreground">Single (collapsible)</h3>
      ...
      <div class="w-full max-w-md">
        ...
        <div sc-accordion type="multiple" [value]="['item-a', 'item-b']">
          <div sc-accordion-item value="item-a">
            ...
            <div sc-accordion-content>
              Yes! When using type="multiple", you can have multiple accordion items open at the
              same time.
            </div>
          </div>
          <div sc-accordion-item value="item-b">
            ...
            <div sc-accordion-content>
              The value is an array of strings representing the currently open items. You can bind
              to it with [(value)].
            </div>
          </div>
          <div sc-accordion-item value="item-c">
            ...
            <div sc-accordion-content>
              Each item uses proper ARIA attributes including aria-expanded and role="region" for
              the content.
            </div>
          </div>
        </div>
      ...
      <!-- With Disabled Item -->
      <div class="w-full max-w-md">
        <h3 class="mb-4 text-sm font-medium text-muted-foreground">With Disabled Item</h3>

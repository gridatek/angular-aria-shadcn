...
import { ScCopyButton, ScCopyButtonWithText, ScCopyCode, ScCopyInput } from '../../ui/copy-button';
    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          <span class="text-sm text-muted-foreground">Click to copy "Hello, World!"</span>
          <button sc-copy-button [value]="'Hello, World!'" (copySuccess)="onCopy($event)"></button>
        </div>
        @if (lastCopied()) {
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <button sc-copy-button [value]="'Ghost variant'" variant="ghost"></button>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-sm text-muted-foreground">Outline:</span>
            <button sc-copy-button [value]="'Outline variant'" variant="outline"></button>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-sm text-muted-foreground">Default:</span>
            <button sc-copy-button [value]="'Default variant'" variant="default"></button>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <button sc-copy-button [value]="'Small'" size="sm" variant="outline"></button>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-sm text-muted-foreground">Default:</span>
            <button sc-copy-button [value]="'Default'" size="default" variant="outline"></button>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-sm text-muted-foreground">Large:</span>
            <button sc-copy-button [value]="'Large'" size="lg" variant="outline"></button>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-sm text-muted-foreground">Icon:</span>
            <button sc-copy-button [value]="'Icon'" size="icon" variant="outline"></button>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3 max-w-md">
          <div>
            ...
            <div sc-copy-input [value]="'https://example.com/share/abc123'" class="mt-1"></div>
          </div>
          <div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 rounded-md border bg-muted/50 px-3 py-2 max-w-md">
          <code class="flex-1 text-sm font-mono">npm install &#64;angular/core</code>
          <button sc-copy-button [value]="'npm install @angular/core'" size="sm"></button>
        </div>
      </div>
        ...
        <div class="space-y-4 max-w-lg">
          ...
          <div class="rounded-lg border p-4">
            ...
            <div class="flex items-center gap-2">
              ...
              />
              <button sc-copy-button [value]="shareUrl" variant="outline" size="icon"></button>
            </div>
          </div>
          ...
          <!-- Promo Code -->
          <div class="rounded-lg border bg-gradient-to-r from-purple-500/10 to-pink-500/10 p-4">
            <h4 class="text-sm font-medium mb-1">Your promo code</h4>
            <div class="flex items-center justify-between">
              <code class="text-2xl font-bold tracking-wider">SAVE20</code>
              <button sc-copy-button [value]="'SAVE20'" variant="outline" size="default">
                Copy Code
              </button>
            </div>
          </div>

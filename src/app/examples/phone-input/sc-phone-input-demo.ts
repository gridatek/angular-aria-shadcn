...
import { ScPhoneInput, ScPhoneInputSimple, Country } from '../../ui/phone-input';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Value: {{ phoneWithCountry() || 'Empty' }}</p>
      </section>
      ...
      <section class="space-y-3">
        ...
        <div class="max-w-sm">
          <sc-phone-input-simple [(value)]="phoneUS" format="us" placeholder="(555) 555-5555" />
        </div>
        <p class="text-sm text-muted-foreground">Value: {{ phoneUS() || 'Empty' }}</p>
      </section>

      <!-- Simple Phone Input (International Format) -->
      <section class="space-y-3">
        <h3 class="text-lg font-semibold">Simple Input (International Format)</h3>
        <p class="text-sm text-muted-foreground">
        ...
        <p class="text-sm text-muted-foreground">Value: {{ phoneInternational() || 'Empty' }}</p>
      </section>

      <!-- Without Icon -->
      <section class="space-y-3">
        <h3 class="text-lg font-semibold">Without Icon</h3>
        <p class="text-sm text-muted-foreground">Simple phone input without the phone icon.</p>
        <div class="max-w-sm">
          <sc-phone-input-simple [showIcon]="false" format="us" placeholder="Enter phone number" />
        </div>
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Disabled phone input states.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Phone input used in a contact form.</p>

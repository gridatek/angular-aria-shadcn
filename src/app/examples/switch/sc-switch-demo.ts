    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center space-x-2">
            <button sc-switch [checked]="true" [disabled]="true" id="disabled-on"></button>
            <label for="disabled-on" class="text-sm font-medium leading-none text-muted-foreground">
              Disabled (On)
            </label>
          </div>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="w-[400px] rounded-lg border p-4">
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              <div class="space-y-0.5">
                <label for="security" class="text-sm font-medium">Security emails</label>
                <p class="text-sm text-muted-foreground">
            ...
            <div class="flex items-center justify-between">
              <div class="space-y-0.5">
                <label for="updates" class="text-sm font-medium">Product updates</label>
                <p class="text-sm text-muted-foreground">

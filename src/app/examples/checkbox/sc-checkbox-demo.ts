      ...
      <div class="space-y-4">
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-center space-x-2">
            ...
            <label for="disabled-unchecked" class="text-sm font-medium leading-none opacity-70">
              Disabled unchecked
            </label>
          </div>
          <div class="flex items-center space-x-2">
        ...
        <div class="flex flex-col gap-4">
          <div class="flex items-center space-x-2">
            <sc-checkbox
              ...
              id="select-all"
            />
            <label for="select-all" class="text-sm font-medium leading-none">Select all</label>
          </div>
...
export class ScCheckboxDemo {
  ...
  readonly someSelected = () => {
    const selected = [this.item1(), this.item2(), this.item3()].filter(Boolean).length;

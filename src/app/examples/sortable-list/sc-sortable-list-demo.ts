...
@Component({
  ...
  imports: [ScSortableList, ScSortableItem, ScSortableHandle, ScSortableOverlay, JsonPipe],
  template: `
    <div class="space-y-8">
      <!-- Basic Sortable List -->
      <div class="space-y-4">
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-md">
          <div sc-sortable-list [(items)]="handleItems" [handleOnly]="true" class="gap-2">
            <div sc-sortable-overlay></div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-lg">
          <div class="rounded-lg border">
            ...
            <div sc-sortable-list [(items)]="playlist" [handleOnly]="true" class="divide-y">
              <div sc-sortable-overlay></div>
              @for (song of playlist(); track song.id; let i = $index) {
                ...
                >
                  ...
                  <span class="text-sm text-muted-foreground">{{ song.duration }}</span>
                </div>
              }
            </div>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-lg">
          ...
          <p class="mt-2 text-sm text-muted-foreground">Use Left/Right arrow keys to reorder.</p>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="max-w-md">
          <div
            ...
            class="gap-2"
          >
            @for (item of ['Item 1', 'Item 2', 'Item 3']; track item; let i = $index) {
              <div
                sc-sortable-item
                [index]="i"
                [item]="item"
...
export class ScSortableListDemo {
  readonly basicItems = signal(['Apple', 'Banana', 'Cherry', 'Date', 'Elderberry']);

  readonly handleItems = signal(['Drag me by handle', 'Reorder with grip', 'Move up or down']);
  ...
  readonly playlist = signal<PlaylistItem[]>([
    ...
    { id: 5, title: 'Comfortably Numb', artist: 'Pink Floyd', duration: '6:24' },
  ]);

...
export class NotificationCenterDemoComponent {
  ...
  readonly groupedNotifications = signal<Notification[]>([
    ...
    },
    {
      ...
      description: 'Version 2.5.0 is now available with new features and bug fixes.',
      type: 'info',
    ...
    },
    {
      ...
      description: 'Your payment method was declined. Please update your billing info.',
      type: 'error',

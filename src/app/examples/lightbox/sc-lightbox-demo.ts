...
import { ScLightbox, ScLightboxTrigger, ScLightboxGallery, LightboxImage } from '../../ui/lightbox';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <sc-lightbox-gallery [images]="galleryImages" class="grid-cols-4 gap-2 max-w-xl" />
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Hide the zoom controls for simpler viewing.</p>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Lightbox with a single image (no navigation).</p>
      ...
      <section class="space-y-3">
        ...
        <ul class="text-sm space-y-1 list-disc list-inside text-muted-foreground">
          <li>
            ...
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">→</kbd> - Navigate images
          </li>
          <li>
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">+</kbd> /
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">-</kbd> - Zoom in/out
          </li>
          <li><kbd class="px-1 py-0.5 bg-muted rounded text-xs">0</kbd> - Reset zoom</li>
          <li><kbd class="px-1 py-0.5 bg-muted rounded text-xs">Esc</kbd> - Close lightbox</li>
        </ul>

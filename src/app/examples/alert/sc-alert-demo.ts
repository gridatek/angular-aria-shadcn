...
import { ScAlert, ScAlertDescription, ScAlertTitle } from '../../ui/alert';
    ...
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <div sc-alert>
          ...
          <div sc-alert-description>You can add components to your app using the cli.</div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div sc-alert variant="destructive">
          ...
          <div sc-alert-description>Your session has expired. Please log in again.</div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div sc-alert class="border-green-500/50 text-green-600 [&>svg]:text-green-600">
          ...
          <div sc-alert-description>Your changes have been saved successfully.</div>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div sc-alert>
          ...
          <div sc-alert-description>
            <p>
              We've updated our Terms of Service. Please review the changes carefully as they affect
              how we handle your data and your rights as a user.
            </p>
            <p class="mt-2">
              Key changes include updated privacy policies, new data retention rules, and
              modifications to our refund policy.
            </p>
          </div>
        </div>
      </div>

...
import { ScHoverCard, ScHoverCardContent, ScHoverCardTrigger } from '../../ui/hover-card';
        ...
        <div sc-hover-card-content>
          <div class="flex justify-between gap-4">
            ...
            <div class="space-y-1">
              ...
              <p class="text-sm text-muted-foreground">The modern web developer's platform.</p>
              <div class="flex items-center pt-2">
                ...
                <span class="text-xs text-muted-foreground">Joined September 2014</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div sc-hover-card-content>
          <div class="space-y-2">
            ...
            <p class="text-sm text-muted-foreground">
              ...
              They're useful for showing previews or additional context.
            </p>
          </div>
        </div>
      </div>
      ...
      <div sc-hover-card side="top" align="start">
        ...
        <div sc-hover-card-content>
          <div class="space-y-2">
            <h4 class="text-sm font-semibold">Angular</h4>
            <p class="text-sm text-muted-foreground">
              Angular is a TypeScript-based web application framework led by the Angular Team at
              Google. It's a complete rewrite of AngularJS.
            </p>

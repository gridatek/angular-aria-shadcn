...
import { ScImageCompare } from '../../ui/image-compare';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Use custom labels for the comparison.</p>
        <sc-image-compare
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Clean comparison without overlay labels.</p>
        <sc-image-compare
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Compare images with a vertical slider.</p>
        <sc-image-compare
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Start with the slider at 25%.</p>
        <sc-image-compare
          ...
          class="w-full max-w-2xl aspect-[2/1]"
        />
        <p class="text-sm text-muted-foreground">Current position: {{ customPosition() }}%</p>
      </section>

      <!-- Controlled Position -->
      <section class="space-y-3">
        <h3 class="text-lg font-semibold">Controlled Position</h3>
        <p class="text-sm text-muted-foreground">Control the slider position with a range input.</p>
        <sc-image-compare
        ...
        <div class="flex items-center gap-4 max-w-2xl">
          <input
            ...
            class="flex-1"
          />
          <span class="text-sm w-12 text-right">{{ controlledPosition() }}%</span>
        </div>
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Works with any aspect ratio.</p>
        <sc-image-compare
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Focus the comparison and use arrow keys to adjust. Hold Shift for larger steps.
        </p>
        <ul class="text-sm space-y-1 list-disc list-inside text-muted-foreground">
          <li>
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">←</kbd> /
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">→</kbd> - Move slider
          </li>
          <li><kbd class="px-1 py-0.5 bg-muted rounded text-xs">Home</kbd> - Go to start</li>
          <li><kbd class="px-1 py-0.5 bg-muted rounded text-xs">End</kbd> - Go to end</li>
          <li>
            <kbd class="px-1 py-0.5 bg-muted rounded text-xs">Shift</kbd> + Arrow - Move by 10%
          </li>
        </ul>
        <sc-image-compare

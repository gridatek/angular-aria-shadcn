...
import { ScMultiSelect, MultiSelectOption } from '../../ui/multi-select';
    ...
    <div class="space-y-8">
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Select multiple options from a dropdown. Selected items appear as chips.
        </p>
        <div class="max-w-sm">
          <sc-multi-select
            [(value)]="basicValue"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Enable the "Select All" option to quickly select or deselect all items.
        </p>
        <div class="max-w-sm">
          <sc-multi-select
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">
          Show selected count instead of individual chips for a more compact display.
        </p>
        <div class="max-w-sm">
          <sc-multi-select
            [(value)]="countValue"
      ...
      <section class="space-y-3">
        ...
        <div class="max-w-sm">
          <sc-multi-select [options]="optionsWithDisabled" placeholder="Select frameworks..." />
        </div>
      </section>
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Disable the search input for simpler lists.</p>
        <div class="max-w-sm">
          <sc-multi-select
            [options]="sizeOptions"
            [searchable]="false"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Disabled multi-select state.</p>
        <div class="max-w-sm">
          <sc-multi-select
            [options]="fruitOptions"
            [disabled]="true"
      ...
      <section class="space-y-3">
        ...
        <p class="text-sm text-muted-foreground">Multi-select used in a user preferences form.</p>

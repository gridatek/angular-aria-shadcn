...
import { ScCodeEditor, THEMES, Language } from '../../ui/code-editor';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        <sc-code-editor [(value)]="htmlCode" [language]="'html'" [filename]="'index.html'" />
      </section>
      ...
      <section>
        ...
        <sc-code-editor [(value)]="pythonCode" [language]="'python'" [filename]="'script.py'" />
      </section>

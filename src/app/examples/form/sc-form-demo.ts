  ...
  template: `
    <div class="space-y-8">
      ...
      <div class="space-y-4">
        ...
        <form [formGroup]="basicForm" (ngSubmit)="onBasicSubmit()" class="max-w-sm space-y-6">
          <div sc-form-field name="username">
            <div sc-form-item>
              ...
              @if (basicForm.get('username')?.invalid && basicForm.get('username')?.touched) {
                <p sc-form-message></p>
              }
            </div>
          </div>
      ...
      <div class="space-y-4">
        ...
        <form [formGroup]="profileForm" (ngSubmit)="onProfileSubmit()" class="max-w-sm space-y-6">
          <div sc-form-field name="name">
            <div sc-form-item>
              ...
              />
              <p sc-form-description>Your full name as it will appear on your profile.</p>
          ...
          <div sc-form-field name="bio">
            <div sc-form-item>
              ...
              <textarea
                ...
                rows="3"
              ></textarea>
              <p sc-form-description>Brief description for your profile. Maximum 160 characters.</p>
        ...
        <form [formGroup]="validationForm" class="max-w-sm space-y-6">
          <div sc-form-field name="required">
            <div sc-form-item>
              ...
              />
              @if (
                validationForm.get('required')?.invalid && validationForm.get('required')?.touched
              ) {
                <p sc-form-message></p>
              }
            </div>
          ...
          <div sc-form-field name="minLength">
            <div sc-form-item>
              ...
              />
              @if (
                validationForm.get('minLength')?.invalid && validationForm.get('minLength')?.touched
              ) {
                <p sc-form-message></p>
              }
            </div>
          ...
          <div sc-form-field name="email">
            <div sc-form-item>
              ...
              />
              @if (validationForm.get('email')?.invalid && validationForm.get('email')?.touched) {
                <p sc-form-message></p>
              }
            </div>
          </div>

          <button sc-button type="button" (click)="touchAllValidation()">Validate All</button>
        </form>
      </div>
    </div>
  `,

...
import { ScSplitButton, type SplitButtonAction } from '../../ui/split-button';
  ...
  template: `
    <div class="space-y-8">
      ...
      <section>
        ...
        />
        @if (lastAction()) {
          <p class="mt-2 text-sm text-muted-foreground">Action: {{ lastAction() }}</p>
        }
      </section>
      ...
      <section>
        ...
        <div class="flex flex-wrap gap-4">
          <sc-split-button label="Default" variant="default" [actions]="basicActions()" />
          <sc-split-button label="Secondary" variant="secondary" [actions]="basicActions()" />
          <sc-split-button label="Outline" variant="outline" [actions]="basicActions()" />
          <sc-split-button label="Destructive" variant="destructive" [actions]="basicActions()" />
        </div>
      </section>
      ...
      <section>
        ...
        <p class="text-sm text-muted-foreground mb-4">Different sizes for various use cases.</p>
      ...
      <section>
        ...
        <sc-split-button label="Disabled" [actions]="basicActions()" [disabled]="true" />
      </section>

      <!-- Real World Example -->
      <section>
        <h3 class="text-lg font-medium mb-4">Email Compose Example</h3>
        <p class="text-sm text-muted-foreground mb-4">Common pattern in email applications.</p>

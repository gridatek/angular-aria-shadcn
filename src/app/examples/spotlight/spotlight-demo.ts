...
@Component({
  ...
  imports: [ScSpotlight, ScSpotlightTitle, ScSpotlightDescription, ScSpotlightActions],
  template: `
    <div class="space-y-8">
      <!-- Demo elements -->
      <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div
          ...
          class="p-6 border rounded-lg bg-card hover:shadow-md transition-shadow"
        >
          <div class="size-12 rounded-full bg-green-500/10 flex items-center justify-center mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <div
          ...
          class="p-6 border rounded-lg bg-card hover:shadow-md transition-shadow"
        >
          <div class="size-12 rounded-full bg-blue-500/10 flex items-center justify-center mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
      ...
      <div class="p-6 border rounded-lg bg-card">
        ...
        <p class="text-sm text-muted-foreground mb-4">
          Click the button below to see the spotlight in action with custom content.
        </p>
        <button
          id="spotlight-cta"
          type="button"
      ...
      <sc-spotlight #spotlight1 [padding]="12" [borderRadius]="12" (closed)="onClosed('Feature 1')">
        <sc-spotlight-title>New Feature Available!</sc-spotlight-title>
        <sc-spotlight-description>
          This exciting new feature helps you work more efficiently. Click to learn more about how
          it works.
        </sc-spotlight-description>
      ...
      <sc-spotlight #spotlight2 [overlayOpacity]="0.8" [showClose]="false">
        ...
        <sc-spotlight-description>
          Access frequently used actions from here. You can customize which actions appear.
        </sc-spotlight-description>
        <sc-spotlight-actions>
          <button
            type="button"
      ...
      <sc-spotlight #spotlight3 [contentPlacement]="'bottom'">
        ...
        <sc-spotlight-description>
          Our help center has guides, tutorials, and FAQs to help you get the most out of the
          application.
        </sc-spotlight-description>
        <sc-spotlight-actions>
          <button
      ...
      <sc-spotlight #spotlightCTA [padding]="16" [borderRadius]="12" [overlayOpacity]="0.85">
        <sc-spotlight-title>Unlock Premium Features</sc-spotlight-title>
        <sc-spotlight-description>
          Upgrade to premium to access advanced analytics, priority support, and exclusive features.
        </sc-spotlight-description>
        <sc-spotlight-actions>
          <button
            type="button"
...
export class SpotlightDemoComponent {
  ...
  private readonly spotlightCTA = viewChild.required<ScSpotlight>('spotlightCTA');

    ...
    <div class="space-y-8">
      ...
      <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Alert Dialog</h3>
          <p class="text-sm text-muted-foreground mt-2">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Navigation Menu</h3>
          <p class="text-sm text-muted-foreground mt-2">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Toggle Group</h3>
          <p class="text-sm text-muted-foreground mt-2">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Aspect Ratio</h3>
          <p class="text-sm text-muted-foreground mt-2">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Number Input</h3>
          <p class="text-sm text-muted-foreground mt-2">
        ...
        <a
          ...
          class="group relative rounded-lg border p-6 hover:bg-accent transition-colors"
        >
          <h3 class="font-semibold leading-none tracking-tight">Multi-Select</h3>
          <p class="text-sm text-muted-foreground mt-2">

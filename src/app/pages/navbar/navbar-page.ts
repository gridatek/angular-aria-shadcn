    ...
    <div class="min-h-screen flex flex-col">
      ...
      <nav sc-navbar class="sticky top-0 z-50" [(mobileMenuOpen)]="mobileMenuOpen">
        ...
        <div sc-navbar-actions>
          ...
          <button sc-button variant="ghost" class="hidden md:inline-flex">Sign In</button>
      ...
      <main class="flex-1">
        <!-- Hero Section -->
        <section class="py-20 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-background to-muted/30">
          <div class="max-w-4xl mx-auto text-center space-y-6">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              Build Something Amazing
            </h1>
            <p class="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              A complete design system with responsive components built for modern web applications.
              Start building beautiful interfaces today.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
              <button sc-button size="lg">Get Started Free</button>
              <button sc-button variant="outline" size="lg">View Documentation</button>
            </div>
          </div>
        </section>
        ...
        <section class="py-16 px-4 md:px-6 lg:px-8">
          <div class="max-w-6xl mx-auto">
            <h2 class="text-2xl md:text-3xl font-bold text-center mb-12">Features</h2>
            <div class="grid md:grid-cols-3 gap-8">
              <div class="p-6 rounded-lg border bg-card">
                ...
                <p class="text-muted-foreground">
                  Automatically adapts between desktop and mobile layouts with smooth transitions.
                </p>
              </div>
              <div class="p-6 rounded-lg border bg-card">
                <div
                ...
                <p class="text-muted-foreground">
                  Built with ARIA attributes, keyboard navigation, and screen reader support.
                </p>
              </div>
              <div class="p-6 rounded-lg border bg-card">
                <div
